...
This Internet-Draft is submitted in full conformance with the provisions of BCP 78 and BCP 79. Internet-Drafts are working documents of the Internet Engineering Task Force (IETF). The list of current Internet-Drafts is at https://datatracker.ietf.org/drafts/current/.
...
Copyright (c) 2026 IETF Trust and the persons identified as the document authors. All rights reserved. This document is subject to BCP 78 and the IETF Trust's Legal Provisions Relating to IETF Documents (https://trustee.ietf.org/license-info).
...
1. [Introduction](#1-introduction)
   ...
   - 1.2 [Scope and Purpose](#12-scope-and-purpose)
   - 1.3 [Relationship to Existing BMWG Work](#13-relationship-to-existing-bmwg-work)
   - 1.4 [Relationship to Companion Documents](#14-relationship-to-companion-documents)
2. [General Benchmarking Terms](#2-general-benchmarking-terms)
3. [Collective Communication Terms](#3-collective-communication-terms)
4. [Distributed Parallelism Strategy Terms](#4-distributed-parallelism-strategy-terms)
5. [Network Transport Terms](#5-network-transport-terms)
   - 5.1 [RoCEv2 and RDMA Terms](#51-rocev2-and-rdma-terms)
   - 5.2 [Ultra Ethernet Transport (UET) Terms](#52-ultra-ethernet-transport-uet-terms)
6. [Congestion Control and Fabric Behavior Terms](#6-congestion-control-and-fabric-behavior-terms)
7. [Fabric Topology and Infrastructure Terms](#7-fabric-topology-and-infrastructure-terms)
8. [Training-Specific Terms](#8-training-specific-terms)
9. [Inference-Specific Terms](#9-inference-specific-terms)
10. [KPI Classification Terms](#10-kpi-classification-terms)
11. [Referenced Standards Abbreviations](#11-referenced-standards-abbreviations)
12. [Security Considerations](#12-security-considerations)
13. [IANA Considerations](#13-iana-considerations)
14. [References](#14-references)
- [Appendix A: Term Cross-Reference to Companion Documents](#appendix-a-term-cross-reference-to-companion-documents)
- [Appendix B: Term Taxonomy Summary](#appendix-b-term-taxonomy-summary)
...
This document defines terminology specifically for benchmarking Ethernet-based AI network fabrics in controlled laboratory environments as specified by the BMWG charter. The defined terms cover: distributed AI training collective communication patterns, LLM inference serving architectures, RDMA transport semantics (RoCEv2 and UET), congestion control mechanisms, fabric topology characteristics, and performance metric definitions.
...
- `draft-bmwg-ai-fabric-terminology-00` **(this document):** Terminology definitions.
- `draft-bmwg-ai-fabric-training-bench-00` [TRAINING-BENCH-00]: Benchmarking methodology for AI training workloads.
- `draft-bmwg-ai-fabric-inference-bench-00` [INFERENCE-BENCH-00]: Benchmarking methodology for AI inference serving workloads.
...
The following terms define RDMA and RoCEv2 transport semantics as used in AI fabric benchmarking.
...
The following terms define UET-specific concepts introduced by the Ultra Ethernet Consortium (UEC) Specification 1.0.
...
The following terms are specific to AI training workload benchmarking and are used normatively in [TRAINING-BENCH-00].
...
The following terms are specific to AI inference serving workload benchmarking and are used normatively in [INFERENCE-BENCH-00].
...
This document defines terminology for use in controlled laboratory benchmarking environments. As such it does not define protocols, algorithms, or operational procedures that introduce security vulnerabilities.

Benchmarking activities **SHOULD** be conducted in isolated test networks that are not connected to production infrastructure. AI fabric benchmarking generates substantial traffic volumes (multi-terabit aggregate); inadvertent exposure to operational networks could cause service disruption.

Published benchmarking results **MUST** accurately represent the tested configuration including DUT hardware and firmware versions, transport configuration, and topology. Selective reporting of favorable configurations while omitting constraints may mislead procurement decisions.

Refer to [RFC2544] Section 6 and the companion methodology documents for additional security considerations related to test traffic isolation and result integrity.
...
The companion document [INFERENCE-BENCH-00] references UDP port 4793 as the destination port for UET traffic. The authors note that IANA assignment of this port number for UET **SHOULD** be verified against the IANA Service Name and Transport Protocol Port Number Registry prior to publication of that document. The UEC Specification 1.0 assignment status **SHOULD** be confirmed by the document authors.
...
| [RFC1242] | Bradner, S., "Benchmarking Terminology for Network Interconnect Devices", RFC 1242, DOI 10.17487/RFC1242, July 1991. https://www.rfc-editor.org/info/rfc1242 |
...
| Reference | Details |
|---|---|
| [RFC8238] | Bitar, N., et al., "Data Center Benchmarking Terminology", RFC 8238, DOI 10.17487/RFC8238, August 2017. https://www.rfc-editor.org/info/rfc8238 |
| [RFC8239] | Bitar, N., et al., "Data Center Benchmarking Methodology", RFC 8239, DOI 10.17487/RFC8239, August 2017. https://www.rfc-editor.org/info/rfc8239 |
| [RFC3168] | Ramakrishnan, K., Floyd, S., and D. Black, "The Addition of Explicit Congestion Notification (ECN) to IP", RFC 3168, DOI 10.17487/RFC3168, September 2001. https://www.rfc-editor.org/info/rfc3168 |
| [IBTA-ROCE] | InfiniBand Trade Association, "InfiniBand Architecture Specification, Annex 16: RoCE", 2010. https://www.infinibandta.org |
| [UEC-SPEC-1.0] | Ultra Ethernet Consortium, "Ultra Ethernet Specification 1.0", 2024. https://ultraethernet.org (Note: Non-IETF reference; downref registry entry required per BCP 97 for normative use.) |
| [TRAINING-BENCH-00] | Calabria, F. and C. Pignataro, "Benchmarking Methodology for AI Training Network Fabrics", draft-bmwg-ai-fabric-training-bench-00, Work in Progress, February 2026. |
| [INFERENCE-BENCH-00] | Calabria, F. and C. Pignataro, "Benchmarking Methodology for AI Inference Serving Network Fabrics", draft-bmwg-ai-fabric-inference-bench-00, Work in Progress, February 2026. |
...
The following table provides a concise summary of all defined terms organized by category.
...
**Total defined terms: 73** across 10 definition sections.
