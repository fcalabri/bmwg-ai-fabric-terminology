...
| Parallelism Strategies (§4) | PP, EP, MoE, ZeRO | DP, TP, EP, MoE, DP Attention |
...
| 7 | Fabric DUT Boundary, Intra-Node Transfer Overhead, Fabric-Visible Data Volume, Clos/Fat-Tree, Rail-Optimized, Bisection Bandwidth, Oversubscription Ratio, ToR Switch, Spine/Superspine, NIC, Buffer Occupancy, Zero-Impact Failover, Link Utilization | Fabric Topology |
